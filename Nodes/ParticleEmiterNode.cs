...
namespace Color_Breaker
{
    public class ParticleEmiterNode : Node
    {
        ...
        public ParticleEmiterNode(Texture2D texture)
        {
            _texture = texture;
        ...
        public override void Update(float deltaTime)
        {
            ...
            for (int i = 0; i < Amount * deltaTime; i++)
            {
                ...
                ParticleNode particle = new ParticleNode(_texture, dir, (float)rnd.NextDouble() * 0.8f);
    ...
    public class ParticleNode : SpriteNode
    {
        ...
        public ParticleNode(Texture2D texture, Vector2 velocity, float lifeTime) : base(texture, Layers.Particles)
        {
            _velocity = velocity;
            _lifeTime = lifeTime;
        }
